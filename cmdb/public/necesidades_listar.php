...
<head>
    ...
    <title>Necesidades de Equipo - TechSolutions</title>
    ...
    <div class="dashboard container">
        <div class="dashboard-container">
            <div class="section-title">
                <h2><i class="fas fa-clipboard-list"></i> Solicitudes de Equipo</h2>
                <a href="necesidades_formulario.php" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="white-space: normal;"><?= htmlspecialchars($s['descripcion']) ?></td>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <?php if ($pend): ?>
                                                <form method="post" action="necesidades_procesar.php" style="display:inline">
                                                    <input type="hidden" name="id" value="<?= $s['id'] ?>">
                                                    <button type="submit" name="accion" value="completar" class="btn-sm btn-completar">
                                                        <i class="fas fa-check"></i> Completar
                                                    </button>
                                                </form>
                                                <form method="post" action="necesidades_procesar.php" style="display:inline">
                                                    <input type="hidden" name="id" value="<?= $s['id'] ?>">
                                                    <button type="submit" name="accion" value="rechazar" class="btn-sm btn-rechazar">
