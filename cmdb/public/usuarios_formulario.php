...
$model = new Usuario();
$usuario = ['id' => '', 'nombre' => '', 'correo' => '', 'cedula' => ''];
$modo = 'nuevo';
...
<head>
    ...
    <title><?= $modo === 'editar' ? 'Editar Usuario' : 'Nuevo Usuario' ?> - TechSolutions</title>
            ...
            <div class="user-form">
                <form method="post" action="usuarios_procesar.php">
                    ...
                    <div class="form-actions">
                        <a href="usuarios_listar.php" class="btn-cancel">
                            <i class="fas fa-arrow-left"></i> Volver al listado
                        </a>
                        <button type="submit" class="btn-submit">
                            <i class="fas <?= $modo === 'editar' ? 'fa-sync' : 'fa-save' ?>"></i>
